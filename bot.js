...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,' made by AK','Type ahelp |asupport ',`${client.users.size} Members`,'ainvite','By: AK'];
    var i = -1;
    var j = 0;
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`http://www.twitch.tv/AK`);
    }, ms);
...
const x5bz4 = [
 ...
 client.on('message', message => {
 if (message.content.startsWith('aمريم')) {
...
**
        ***__General orders__***
**
『aserver/يعرض لك معلومات عن السيرفر』
『aallbots/ لمعرفه عدد البوتات في السيرفر』
『abotin/يعرض لك  كل معلومات البوت』
『asupport /للتواصل مع صاحب البوت』
『aid/معلومات  عنك』
『ainvite/لدعوه البوت الي سيرفرك 』
『aavatar /للعرض صورتك او صورة شخص فقط قم بعمل منشن له 』
『aembed /البوت يكرر الكلام الي قلته ب امبد
『amembers/��عرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص』
『aavatar/صورتك او صورة الي تمنشنو』
『aask/يبحث عن الكلمه الي تكتبها باالانجليزي』
『ainvites /لمعرفه كم شخص دعوت الي السيرفر』
『auptime / لمعرالبوت اون لاين منذ متي』  
『❖❖❖اومر مميزه نادره❖❖❖』
『adaily /علشان تخد الكرديت اليومي 』
『acredit / لكي تري الكرديت الخاص باك』
『atrans <@someone> <number / للتبرع لحد بلكريدت』
『aboom /  يطير جبه الي تبي عن طريق المنشن』
『asad / يقول للشخص انك خزين بسببه  او زعلان منه عن طريق المنشن』
『akiss/يعطي قبله لمن تختار في السيرفر عن طريق المنشن』
『alove / يعبر بشعورك بلحب  لمن تختار في السيرفر عن طريق المنشن』
『amiss / يرسله اشتقت لك لمن تختار في السيرفر عن طريق المنشن』
『aslap / يعطي كف لمن تختاره في السيرفرعن طريق المنشن』
『ahug /  يعطي وحضن او ضمه لمن تختاره في السيرفر عن طريق المنشن』
『acat/صور قطط صغيره』
『apaint/يجبلك الكلام الي تكتبه في صوره』
『atrans/يترجم الكلمه الي تكتبه ال اي لغه مع تحديد』
=====اوامر اضافيه====
『ترحيب』
『باك』
『السلام عليكم』
...
**
『aclear <numbr> / البوت يمسح الرسال برقم حد اقصي 100 رساله』
『asay / البوت يكرر الكلام الي انت تقوله』
『akick @user <reason> / طرد الشخص من السيرفر』
『aban @user <reason> / حضر الشخص من السيرفر』
『asetstats/ يعمل روم لك بلوقت والتاريخ والاشخاص المتصليف في الرومات』
『abanlist / عدد الاشخاص المبندة 』
『amute / يعطي ميوت للعضو 』
『aunmute /  يفك الميوت عن العضو 』
『agiveaway / يسويلك قف اوي علي الشي الي تبيه』
『asetwelcomer /  <welcome> يجب ان يكون اسم روم الترحيب 』
『anick/ لتغيراسماء جميع الاعضاء』
『amutechannel / لقفل الشات علي الاعضاء في السيرفر』
『aunmutechannel / لفتح الشات لجميع الاعضاء في السيرفر』
made by AK
   `,`
        ***__Music orders__***
**
...
**
        ***__Games orders__***
 **       
『aslots / ['🍏''🍇' '🍒' '🍍' '🍅' '🍆' '🍑' '🍓'] جمع 3 من نفس الشي تفوز』
『لعبه التهكير الوهمي /تهكير منشن الشخص 』
『aلعبة كت تويت / كت تويت』
『aلعبة مريم / مريم』
『تغرaد  للشخص عن طريق المنشن /-غرد』
『amarry/لعبه الزواج لا تفهم غلط』
『نكتaمضحكه/ -نكت』
『arps/لعبه حجر ورقه مقص』
made by AK
**
...
var cont = message.content.slice(prefix.length).split(" ");
  ...
  var args = cont.slice(1);
       if (message.content.startsWith("anick")) {
...
client.on("message", message => {
 if (message.content === "asupport") {
  const embed = new Discord.RichEmbed()
      .setTitle('Click here')
      .setURL(' https://discord.gg/H4JQU9e ')
      .setColor("RANDOM")
      .setFooter('© A BOT :heart: جميع الحقوق محفوظة 2018 لــبوت')  
      .addField('سيرفر الدعم الفني', ` https://discord.gg/H4JQU9e  `)
  message.author.send({embed});
...
client.on('message', message => {
    if (message.content.startsWith("abot")) {
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``A Bot اسمي هوا📇``' , `[ ${client.user.tag} ]` , true)
...
client.on('message',  (message) => {
        if(message.content.startsWith('aboom')) {
  let user = message.mentions.users.first();
  if (!user) {
...
client.on('message',  (message) => {
        if(message.content.startsWith('asad')) {
  let user = message.mentions.users.first();
  if (!user) {
...
client.on('message',  (message) => {
        if(message.content.startsWith('amiss')) {
  let user = message.mentions.users.first();
  if (!user) {
...
var cats = ["http://palestine-kitchen.ps/wp-content/uploads/2017/12/%D9%86%D9%83%D8%AA-%D8%AF%D8%A8%D8%A7%D9%86%D8%A9.png","http://www.i7lm.com/wp-content/uploads/2017/04/136769797816.jpg","https://4.bp.blogspot.com/-p62zmDIDXmI/WKzqNt9smaI/AAAAAAAAC4Q/sW_bSIB8OaQhwOYFeplc3uzz8PBN7l3YACEw/s1600/13602501135.jpg","https://www.universemagic.com/images/2016/03/7938-2-or-1457539273.jpg","https://1.bp.blogspot.com/-yFk-FzHSyE8/WR9fmPcsCUI/AAAAAAAAE6c/AmvjLadOiLY9GiCqMLHgA121bY2RS_dCwCLcB/s1600/%25D9%2586%25D9%2583%25D8%25AA%2B%25D9%2585%25D8%25B6%25D8%25AD%25D9%2583%25D8%25A9%2B1.jpg","https://l7zaat.com/wp-content/uploads/2018/02/423.jpg","https://www.petfinder.com/wp-content/uploads/2012/11/101438745-cat-conjunctivitis-causes.jpg","https://i.fatafeat.com/storage/attachments/15/image3_698123_large.jpg","http://www.shuuf.com/shof/uploads/2018/02/08/jpg/shof_97d686082bdb0a2.jpg"];
        var args = message.content.split(" ").slice(1);
    if(message.content.startsWith(prefix + 'نكتa')) {
         var cat = new Discord.RichEmbed()
.setImage(cats[Math.floor(Math.random() * cats.length)])
message.channel.sendEmbed(cat);
    }
...
client.on('message', async msg => {
 ...
 client.on('message', message => {
if (message.content.startsWith('aask')) {
...
.then(collected =>{ 
  ...
  client.on('message', message => {
if(message.content.startsWith("aslots")) {
  let slot1 = ['🍏', '🍇', '🍒', '🍍', '🍅', '🍆', '🍑', '🍓'];
...
client.on('message', function(message) {
	...
	else if (message.content.startsWith('avol')) {
		if (!message.member.voiceChannel) return message.reply(':x: **You have to be in a voice channel to use this command.**');
		// console.log(args)
	...
	else if (mess.startsWith('apause')) {
		if (!message.member.voiceChannel) return message.reply(':x: **You have to be in a voice channel to use this command.**');
		message.reply(':gear: **تم الايقاف مؤقت**').then(() => {
			dispatcher.pause();
		});
	}
	else if (mess.startsWith('aunpause')) {
		if (!message.member.voiceChannel) return message.reply(':x: **You have to be in a voice channel to use this command.**');
		message.reply(':gear: **تم اعاده التشغيل**').then(() => {
			dispatcher.resume();
		});
	}
	else if (mess.startsWith('astop')) {
		if (!message.member.voiceChannel) return message.reply(':x: **You have to be in a voice channel to use this command.**');
		message.reply(':name_badge: **تم الايقاف**');
		var server = server = servers[message.guild.id];
		if (message.guild.voiceConnection) message.guild.voiceConnection.disconnect();
	}
	else if (mess.startsWith('ajoin')) {
		if (!message.member.voiceChannel) return message.reply(':x: **You have to be in a voice channel to use this command.**');
		message.member.voiceChannel.join().then(message.react('?'));
	}
		else if (mess.startsWith(prefix - 'a')) {
		if (!message.member.voiceChannel) return message.channel.send(':x: **You have to be in a voice channel to use this command.**');
